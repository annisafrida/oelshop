...
// jika tidak ada session pelanggan(belum login,) maka masuk dulu ke login.php
...
<section class="konten">   
     <div class="container">
         ...
         <table class="table table-bordered">  
            ...
            <tbody>
                ...
                <?php 
                    ...
                    ?>
                <!-- menampilkan produk yang sedang diperulangkan berdasakan id_produk -->
                <?php   
        ...
        if (isset($_POST["checkout"]))
        {
        	...
        	// mendapatkan id_pembelian yang sudah terjadi
        	...
        	foreach ($_SESSION["keranjang"] as $id_produk => $jumlah)
        	{
                ...
                $ambil=$koneksi->query("SELECT * FROM produk WHERE id_produk='$id_produk'");
                $arrayproduk = $ambil->fetch_assoc();
                $nama =$perproduk['nama_produk'];
                $harga =$perproduk['harga_produk'];

                $subharga = $perproduk['harga_produk']*jumlah;
        		$koneksi->query("INSERT INTO pembelian_produk (id_pembelian_produk,id_produk,nama,harga,subharga,jumlah) VALUES ('$id_pembelian_barusan','$id_produk','$nama','$harga','$subharga','$jumlah') ");
        	}
        	...
        	// tampilan dilakukan ke halaman nota, nota dari pembelian yang terjadi
